...
export default function LeadsPage() {
    ...
    const handleManualExtraction = async () => {
        ...
        try {
            // 1. CLEAR
            console.log("Step 1: Clearing leads...");
            setLeads([]);
            setExtractionLogs([]);
            await clearAllLeadsAction();

            // 2. FETCH RAW LIST
            console.log("Step 2: Fetching raw leads...");
                                    ...
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex items-center gap-2 mt-4">
                                            <button
                                                ...
                                                className="flex-1 bg-monjez-accent/10 border border-monjez-accent/20 hover:bg-monjez-accent/20 text-monjez-accent px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2"
                                            >
                                                <Mail className="w-4 h-4" />
                                                {copyStatus === lead.id ? "Copied!" : "Copy Outreach"}
                                            </button>
